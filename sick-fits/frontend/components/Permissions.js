...
class UserPermissions extends React.Component {
    ...
    handlePermissionChange = (e) => {
        ...
        //Take a copy of the current permissions ... top level copy of all items of permissions
        // const is read only, let can w
    ...
    render() {
        ...
        >
            ...
            < tr >
              ...
              <td>
                <SickButton type="button" disabled={loading} onClick={updatedPermissions}>
                  Updat{loading ? 'ing' : 'e'}
                </SickButton>
              </td>
            </tr>
